...
export const OverpassService = {
  ...
  // Hinweis: Die Schul-Suche via Overpass wurde durch den PMTiles-Layer
  // (CONFIG.SCHOOLS_PMTILES_URL) ersetzt. Overpass bleibt nur noch für die
  // ÖPNV-Haltestellen-Suche, bis auch dafür ein PMTiles-Layer existiert.
